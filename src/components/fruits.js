...
import '../fruits.css';
import {GetRandom,Randomfruits,Selectedfruit} from './randomfruits';
...
import fruit_title from '../img/title_fruit.png';
...
class fruits extends React.Component {
  constructor(props){
          ...
          this.state={
               ...
               anscheckimg:null,
               selectedNoteval:Selectedfruit(0),
               fruits:GetRandom(0,Randomfruits(0)),
               tagval:null,
               changest:0,
               hide:'block',
               play:true,
    ...
    this._isMounted = false;
     ...
     handleFuritClick(event) {
       ...
       if(tagval === this.state.selectedNoteval[0][1]){
         if (this.state.selectedNoteval[0][0] === 25){
            this.setState({
              hide: 'none',
            })
        ...
        sleep() {
          this.inter = setInterval(() => {
            ...
            if (parseInt(this.state.changest) === 2) {
              ...
              this.setState({
                fruits: GetRandom(this.state.selectedNote, Randomfruits(this.state.selectedNote)),
                selectedNoteval: Selectedfruit(this.state.selectedNote),
                showResults: false,
                showcorrectResults: false,
                anscheckimg: null
              });
